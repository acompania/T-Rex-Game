...
void RenderingHelper::translate(const glm::vec3 &offset)
{
...
void RenderingHelper::rotate(float angle, const glm::vec3 &axis)
{
...
void RenderingHelper::rotateWith(glm::mat4 rotMatrix)
{
	//*currentMatrix = glm::rotate_slow(*currentMatrix, angle, axis);
	//*currentMatrix *= glm::gtx::transform::rotate(angle, axis);
...
void RenderingHelper::lookAt(glm::vec3 eye, glm::vec3 target, glm::vec3 up)
{
